...
void pdsi::Calibrate() {
    ...
    if ((setCalibrationStartYear == 1) || (setCalibrationEndYear == 1)) {
         ...
         */
        for (int i = 0;
            (i < nStartPeriodsToSkip) && (!tmpXlist.is_empty()); i++) {
         ...
         */
        for (int i = 0;
            (i < nEndPeriodsToSkip) && (!tmpXlist.is_empty()); i++) {
...
void pdsi::MoveCMIFiles(char * dir) {
    ...
    if (rename("CMI_calc.tbl", filename) == -1) {
        if (ReprintFile((char * )
                "CMI_calc.tbl", (char * ) filename) == -1 && verbose > 0)
    ...
    if (rename("potentials", filename) == -1) {
        if (ReprintFile((char * )
                "potentials", (char * ) filename) == -1 && verbose > 0)
    ...
    if (rename("WB.tbl", filename) == -1) {
        if (ReprintFile((char * )
                "WB.tbl", (char * ) filename) == -1 && verbose > 0)
...
void pdsi::MoveFiles(char * dir) {
    ...
    if (extra == 3 || extra == 9) {
        ...
        if (rename("dvalue", filename) == -1) {
            if (ReprintFile((char * )
                    "dvalue", (char * ) filename) == -1 && verbose > 0)
    ...
    if (extra == 2 || extra == 9) {
        ...
        if (rename("bigTable.tbl", filename) == -1) {
            if (ReprintFile((char * )
                    "bigTable.tbl", (char * ) filename) == -1 && verbose > 0)
...
number pdsi::get_Z_sum(int length, int sign) {
     ...
     */
    for (int i = 0;
        (i < nStartPeriodsToSkip) && (!tempZ.is_empty()); i++) {
